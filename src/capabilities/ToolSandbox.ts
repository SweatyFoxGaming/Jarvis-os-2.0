  ...
  public async executeTool(toolFilePath: string, inputData: any, timeoutMs: number = 2000): Promise<any> {
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        // 1. Load TypeScript in the main thread where it's guaranteed to exist
        const tsRaw = require('typescript');
        
        // 2. Safely bypass the synthetic ESM wrapper generated by tsx
        ...
        // 3. Transpile to plain JavaScript BEFORE sending to the worker
